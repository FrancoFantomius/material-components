export default {
  ...
  properties: [
    ...
    { name: 'wavy', type: 'boolean', default: 'true', description: 'Enables Material 3 wavy line for determinate values' }
  ],
  examples: [
    {
      title: 'Linear & Circular Indicators',
      description: 'Determinate indicators with expressive wavy lines, and indeterminate progress indicators.',
      html: `<!-- Linear Progress with Wavy Line -->
